    ...
    <View style={styles.card}>
      ...
      <View style={styles.cardActions}>
        <TouchableOpacity
          ...
          onPress={() => router.push(`/orang-masuk/edit?id=${item.id}` as any)}
          activeOpacity={0.7}
        >
          <MaterialCommunityIcons
            name="pencil-outline"
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.searchBar}>
        ...
        <TextInput
          ...
          placeholder="Cari nama, asal, keperluan..."
            ...
            {loading ? (
              ...
              <>
                <MaterialCommunityIcons
                  ...
                  color="#2a2d37"
                />
                <Text style={styles.emptyText}>Belum ada data orang masuk</Text>
              </>
            )}
          </View>
        }
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          ...
          onPress={() => router.push("/orang-masuk/add" as any)}
          activeOpacity={0.8}
        >
          <MaterialCommunityIcons name="plus" size={20} color="#fff" />
          <Text style={styles.addButtonText}>Tambah Orang Masuk</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
