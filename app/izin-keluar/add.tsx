...
export default function AddIzinKeluar() {
  ...
  const handleSubmit = async () => {
    if (!nama || !keperluan || !selectedSekuriti) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <ScrollView contentContainerStyle={styles.form}>
          ...
          {/* Time Section */}
          <View style={styles.section}>
            <Text style={styles.sectionLabel}>Waktu Keluar / Masuk</Text>
            <View style={styles.sectionCard}>
              <View style={styles.timeRow}>
                ...
                >
                  ...
                  />
                  <View>
                    <Text style={styles.timeBtnLabel}>Jam Keluar</Text>
                    <Text style={styles.timeBtnValue}>
                      {formatTime(jamKeluar)}
                    </Text>
                  </View>
                </TouchableOpacity>
                <TouchableOpacity
                ...
                >
                  ...
                  />
                  <View>
                    <Text style={styles.timeBtnLabel}>Jam Masuk</Text>
                    <Text style={styles.timeBtnValue}>
                      {formatTime(jamMasuk)}
                    </Text>
                  </View>
