...
export default function EditListSekuriti() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (error || !data) {
        Alert.alert("Error", "Gagal memuat data sekuriti");
        router.back();
        return;
      }
  ...
  const handleSubmit = async () => {
    ...
    if (error) {
      ...
      Alert.alert("Berhasil", "Data sekuriti berhasil diperbarui", [
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Edit Sekuriti</Text>
        <View style={{ width: 40 }} />
      </View>
