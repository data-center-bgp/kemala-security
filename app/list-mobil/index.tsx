...
export default function ListMobilScreen() {
  ...
  const filteredData = useMemo(() => {
    ...
    return data.filter(
      (item) =>
        item.nomor_plat?.toLowerCase().includes(q) ||
    ...
    <View style={styles.card}>
        ...
        <View style={styles.cardTitleArea}>
          ...
          <View style={styles.platBadge}>
            <MaterialCommunityIcons
              ...
              color="#0a7ea4"
            />
            <Text style={styles.platText}>{item.nomor_plat}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.cardBody}>
        <View style={styles.detailRow}>
          <MaterialCommunityIcons name="car-cog" size={16} color="#6b7280" />
          <Text style={styles.detailLabel}>Tipe</Text>
          <Text style={styles.detailValue}>{item.tipe}</Text>
        </View>
        <View style={styles.detailRow}>
          <MaterialCommunityIcons
          ...
          <Text style={styles.detailValue}>{item.warna}</Text>
        </View>
      </View>
      ...
      <View style={styles.cardActions}>
        <TouchableOpacity
          ...
          onPress={() => router.push(`/list-mobil/edit?id=${item.id}` as any)}
          activeOpacity={0.7}
        >
          <MaterialCommunityIcons
            name="pencil-outline"
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>List Mobil</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <View style={styles.searchBar}>
        ...
        <TextInput
          ...
          placeholder="Cari plat, brand, nama, tipe..."
