...
import { OrangKeluar } from "@/types/database";
...
export default function OrangKeluarScreen() {
  const router = useRouter();
  const [data, setData] = useState<OrangKeluar[]>([]);
    ...
    <View style={styles.card}>
      ...
      <View style={styles.cardActions}>
        <TouchableOpacity
          ...
          onPress={() => router.push(`/orang-keluar/edit?id=${item.id}` as any)}
          activeOpacity={0.7}
        >
          <MaterialCommunityIcons
            name="pencil-outline"
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Orang Keluar</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          ...
          onPress={() => router.push("/orang-keluar/add" as any)}
          activeOpacity={0.8}
        >
          <MaterialCommunityIcons name="plus" size={20} color="#fff" />
          <Text style={styles.addButtonText}>Tambah Orang Keluar</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
